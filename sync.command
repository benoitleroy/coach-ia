...
if [ -d .git ]; then
  if ! git diff --quiet js/data-benoit.js js/observations-strava.js js/carnet-data.js js/bilan-data.js js/sommeil-data.js js/seances-data.js js/programme-data.js js/nst-data.js js/mouvements-data.js js/wods-data.js planning.ics 2>/dev/null; then
    echo "📤 Push des nouvelles données vers GitHub Pages…"
    git add js/data-benoit.js js/observations-strava.js js/carnet-data.js js/bilan-data.js js/sommeil-data.js js/seances-data.js js/programme-data.js js/nst-data.js js/mouvements-data.js js/wods-data.js planning.ics
