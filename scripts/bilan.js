...
- ⚠️ NST ET GARDE DES ENFANTS (règle validée par Benoît le 05/09/2026) : les soirs où il a les enfants (voir la section GARDE), JAMAIS de séance NST à la salle ni de séance longue hors de la maison. À la place : soit une version NST MAISON COURTE (~35 min : force principale + travail unilatéral + gainage, SANS le conditioning — matériel maison : barre, haltères, élastiques, box), soit décaler les vraies séances NST sur les jours SANS enfants de la semaine. Les semaines de garde, place le repos et les séances légères (mobilité, home-trainer matinal) en début de semaine et concentre la charge sur les jours libres — la ligne de progression NST doit rester continue d'une semaine à l'autre (au moins 1 stimulus force même en semaine de garde).
